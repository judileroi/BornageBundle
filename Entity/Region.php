 ...
 * Region.
 *
 * @ORM\Table(name="media_bornage_region")
 * @ORM\Entity(repositoryClass="Innova\MediaBornageBundle\Repository\RegionRepository")
 */
class Region implements \JsonSerializable
{
    ...
    /**
     * @var MediaResource
     * @ORM\ManyToOne(targetEntity="Innova\MediaBornageBundle\Entity\MediaResource", inversedBy="regions")
     ...
     * @ORM\OneToOne(targetEntity="Innova\MediaBornageBundle\Entity\RegionConfig", mappedBy="region", cascade={"persist", "remove"})
     */
