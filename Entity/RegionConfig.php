...
namespace Innova\MediaBornageBundle\Entity;
 ...
 * RegionConfig.
 *
 * @ORM\Table(name="media_bornage_region_config")
 * @ORM\Entity
 */
class RegionConfig implements \JsonSerializable
{
    ...
    /**
     * @var region
     * @ORM\OneToOne(targetEntity="Innova\MediaBornageBundle\Entity\Region", inversedBy="regionConfig")
     * @ORM\JoinColumn(nullable=false)
     */
    private $region;

    /**
     * @ORM\OneToMany(targetEntity="Innova\MediaBornageBundle\Entity\HelpText", cascade={"remove", "persist"}, mappedBy="regionConfig")
     */
    private $helpTexts;

    /**
     * @ORM\OneToMany(targetEntity="Innova\MediaBornageBundle\Entity\HelpLink", cascade={"remove", "persist"}, mappedBy="regionConfig")
     */
    private $helpLinks;
