...
class MediaResource extends AbstractResource implements \JsonSerializable
{
     ...
     * @var medias
     *
     * @ORM\OneToMany(targetEntity="Innova\MediaBornageBundle\Entity\Media", cascade={"remove", "persist"}, mappedBy="mediaResource")
     */
    protected $medias;

    /**
     * @ORM\OneToMany(targetEntity="Innova\MediaBornageBundle\Entity\Region", cascade={"remove", "persist"}, mappedBy="mediaResource")
     */
    protected $regions;

    /**
     * @ORM\OneToOne(targetEntity="Innova\MediaBornageBundle\Entity\Options", cascade={"remove", "persist"})
     */
    protected $options;
