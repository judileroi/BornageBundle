...
namespace Innova\MediaBornageBundle\Manager;

use Claroline\CoreBundle\Library\Utilities\ClaroUtilities;
use Doctrine\ORM\EntityManager;
use Innova\MediaBornageBundle\Entity\HelpLink;
use Innova\MediaBornageBundle\Entity\HelpText;
use Innova\MediaBornageBundle\Entity\MediaResource;
use Innova\MediaBornageBundle\Entity\Region;
use Innova\MediaBornageBundle\Entity\RegionConfig;
...
class RegionManager
{
    ...
    {
        return $this->em->getRepository('InnovaMediaBornageBundle:Region');
    }
