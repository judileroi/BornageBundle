...
use Innova\MediaBornageBundle\Entity\Media;
use Innova\MediaBornageBundle\Entity\MediaResource;
use Innova\MediaBornageBundle\Entity\Options;
...
class MediaResourceManager
{
    ...
    {
        return $this->em->getRepository('InnovaMediaBornageBundle:MediaResource');
    }
     ...
     *
     * @return \Innova\MediaBornageBundle\Manager\MediaResourceManager
     */
