...
namespace Innova\MediaBornageBundle\Controller;
...
class MediaResourceController extends Controller
{
    ...
    public function openAction(Workspace $workspace, MediaResource $mr)
    {
        ...
        return $this->render('InnovaMediaBornageBundle:MediaResource:players.html.twig', [
                  '_resource' => $mr,
              ]
      );
    }
    ...
    public function administrateAction(Workspace $workspace, MediaResource $mr)
    {
        ...
        return $this->render('InnovaMediaBornageBundle:MediaResource:administrate.html.twig', [
                    '_resource' => $mr,
          ]
        );
    }
